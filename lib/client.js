...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '.xray-panel{flex:1;min-height:0;display:flex;flex-direction:column;max-width:1080px;width:100%;margin:0 auto;padding:20px 24px;font-size:13px;color:var(--dsw-alias-label-primary)}',
      ...
      '.xray-nav button{font:inherit;font-size:12px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-3);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;padding:6px 11px;cursor:pointer;transition:.2s}',
      '.xray-nav button:hover{background:var(--dsw-alias-interactive-bg-hover)}',
      '.xray-nav button.active{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary);border-color:var(--dsw-alias-state-business-primary);font-weight:600;box-shadow:0 0 18px -12px var(--dsw-alias-state-business-primary)}',
      '.xray-table{border-collapse:collapse;width:100%;margin-top:6px}',
      '.xray-table th,.xray-table td{text-align:left;padding:7px 10px;border-bottom:1px solid var(--dsw-alias-border-l2);vertical-align:top}',
      '.xray-table tr:hover td{background:var(--dsw-alias-interactive-bg-hover)}',
      '.xray-table th{color:var(--dsw-alias-label-tertiary);font-weight:normal;position:sticky;top:0;background:var(--dsw-alias-bg-layer-1)}',
